...
document.writeln("				<span>Email：1160029018@qq.com</span>");
document.writeln("				<span>简书ID：zzFree</span>");
document.writeln("				<span>个人公众微信号：</span>");
document.writeln("			</div>");
document.writeln("			<div id=\'rightContent\'>");
document.writeln("				<div id=\'footIcon\'>");
document.writeln("					<img id=\'logo\' src=\'img/name.ico\' />");
document.writeln("				</div>");
document.writeln("");
document.writeln("				<div id=\'copyright\'>");
document.writeln("					Copyright @ zzFree,Design zzFree,2018-20xx");
document.writeln("				</div>");
document.writeln("			</div>");
